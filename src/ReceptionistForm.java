...
public class ReceptionistForm extends JFrame {
	static ReceptionistForm frame;
	...
	public ReceptionistForm() {
		...
		lblAddReceptionist.setForeground(Color.DARK_GRAY);
		lblAddReceptionist.setFont(new Font("Tahoma", Font.PLAIN, 22));
		...
		JLabel lblQalification = new JLabel("Qualification:");
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			int i=ReceptionistDao.save(name, password, email, Qualification, city, contact);
			if(i>0){
				JOptionPane.showMessageDialog(ReceptionistForm.this,"Receptionist added successfully!");
				MangerSuccess.main(new String[]{});
				frame.dispose();
				
			}else{
				JOptionPane.showMessageDialog(ReceptionistForm.this,"Sorry, unable to save!");
			}
			}
		});
		...
		btnBack.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ReceptionistSuccess.main(new String[]{});
			frame.dispose();
			}
		});
			...
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING, false)
						...
						.addComponent(lblQalification, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addComponent(lblAddReceptionist)
					.addGap(144))
				.addGroup(gl_contentPane.createSequentialGroup()
