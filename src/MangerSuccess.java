...
import java.sql.*;
public class MangerSuccess extends JFrame {
	static MangerSuccess frame;
	...
	public MangerSuccess() {
		...
		JLabel lblMangerSection = new JLabel("Manger Section");
		lblMangerSection.setFont(new Font("Tahoma", Font.PLAIN, 22));
		lblMangerSection.setForeground(Color.GRAY);
		
		JButton btnNewButton = new JButton("Add Receptionist");
		btnNewButton.setFont(new Font("Tahoma", Font.PLAIN, 15));
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			ReceptionistForm.main(new String[]{});
			frame.dispose();
			}
		});
		...
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addComponent(lblMangerSection, GroupLayout.PREFERRED_SIZE, 151, GroupLayout.PREFERRED_SIZE)
					.addGap(123))
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					.addComponent(lblMangerSection, GroupLayout.PREFERRED_SIZE, 40, GroupLayout.PREFERRED_SIZE)
					.addGap(11)
