...
public class UserLogin extends JFrame {
    ...
    public UserLogin() {
        ...
        JLabel lblUserForm = new JLabel(" Tushar'Hotel User Login ");
        lblUserForm.setForeground(Color.GRAY);
        lblUserForm.setFont(new Font("Tahoma", Font.PLAIN, 18));
