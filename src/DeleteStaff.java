		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(sid==null||sid.trim().equals("")){
					JOptionPane.showMessageDialog(DeleteStaff.this,"Id can't be blank");
				}else{
					int id=Integer.parseInt(sid);
					int i=staffDao.delete(id);
					if(i>0){
						JOptionPane.showMessageDialog(DeleteStaff.this,"Record deleted successfully!");
					}else{
						JOptionPane.showMessageDialog(DeleteStaff.this,"Unable to delete given id!");
					}
				}
			}
		});
