...
public class BooksRoom extends JFrame {
    static BooksRoom frame;
    ...
    public BooksRoom() {
        ...
        JButton btnBookRoom = new JButton("Duplex Room");
        btnBookRoom.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	DuplexRoom.main(new String[]{});
            }
        });
        
        JButton btnBookRoom2 = new JButton("Normal Room");
        ...
        gl_contentPane.setVerticalGroup(
            gl_contentPane.createParallelGroup(Alignment.LEADING)
                .addGroup(gl_contentPane.createSequentialGroup()
                    .addComponent(lblBookRoom)
                    .addGap(50)
                    .addComponent(btnBookRoom, GroupLayout.PREFERRED_SIZE, 50, GroupLayout.PREFERRED_SIZE)
                    .addGap(18)
                    .addComponent(btnBookRoom2, GroupLayout.PREFERRED_SIZE, 50, GroupLayout.PREFERRED_SIZE)
