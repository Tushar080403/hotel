...
public class AddStaff extends JFrame {
	...
	public AddStaff() {
		...
		lblAddStaff.setForeground(Color.DARK_GRAY);
		lblAddStaff.setFont(new Font("Tahoma", Font.PLAIN, 22));
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			int i=ReceptionistDao.save(name, password, email, position, city, contact);
			if(i>0){
				JOptionPane.showMessageDialog(AddStaff.this,"Staff membe added successfully!");
				MangerSuccess.main(new String[]{});
				frame.dispose();
				
			}else{
				JOptionPane.showMessageDialog(AddStaff.this,"Sorry, unable to save!");
			}
			}
		});
