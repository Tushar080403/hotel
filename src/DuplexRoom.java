...
public class DuplexRoom extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    DuplexRoom frame = new DuplexRoom();
    ...
    public DuplexRoom() {
        ...
        JLabel lblBookRoom = new JLabel("Book Duplex Room");
        ...
        btnBookRoom.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (i > 0) {
                    JOptionPane.showMessageDialog(DuplexRoom.this, "Payment Page");
                    dispose();
                } else {
                    JOptionPane.showMessageDialog(DuplexRoom.this, "Sorry, unable to book the room!");
